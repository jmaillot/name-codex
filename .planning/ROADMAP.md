...
- ⏳ **v1.12 CAF Expansion III** — Phases 28-29 (planned, 65→71 conventions, Azure 33→39, Region-based lowercase)
...
### v1.12 CAF Expansion III (Phases 28-29) — PLANNED

**Goal:** Expand Azure CAF catalog with six additional high-demand conventions as pure data-driven JSON — EN/FR parity, Region-based lowercase patterns, all gates green.

Shipped: not yet — requires 6 new rule JSON + workload libs, catalog 65→71, Azure 33→39.
...
_Milestone v1.12: 2 phases (28-29) | 6 requirements mapped | Planned — catalog 65→71 (Azure 33→39)._
