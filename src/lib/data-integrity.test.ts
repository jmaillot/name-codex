...
describe("data integrity", () => {
  ...
  it("catalog contains exactly 56 conventions (25 existing + 19 new + 6 CAF -1 grouped VNet GW + 4 data-tier + 3 observability)", () => {
    expect(allConventions.length).toBe(56)
  })
  ...
  it("every new convention is reachable via global-search (name/description/id/pattern match)", () => {
    expect(NEW_CONVENTION_IDS.length).toBe(32)
